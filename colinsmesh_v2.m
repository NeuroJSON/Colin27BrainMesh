...
ROILabels=table({'Scalp_Skull','CSF','WM','GM'}',(1:4)','VariableNames',{'ROI','Label'});
...
mesh=struct('x0x5F_DataInfo_',struct('JMeshVersion','0.5', 'Dimension',3, ...
   ...
   'BrainAtlasName', 'Colin27 Atlas', 'BrainAtlasURL','https://www.mcgill.ca/bic/software/tools-data-analysis/anatomical-mri/atlases/colin-27',...
   'BrainAtlasID','Colin27', 'SegmentationDataVersion','Version 1','BrainROILabels',ROILabels,'Author','Fang Lab (http://fanglab.org)',...
   'Date',datestr(now,29),'MeshGenerator','Brain2Mesh',...
   'Contact','q.fang<at>neu.edu','CitationDOI','http://dx.doi.org/10.1097/00004728-199803000-00032','Citation',...
...
tic;savejson('',mesh,'filename','MMC_Collins_Atlas_Mesh_Version_2L.jmsh','compression','zlib');toc
tic;savebj('',mesh,'filename','MMC_Collins_Atlas_Mesh_Version_2L.bmsh','compression','zlib');toc

fprintf(1, '===================================================  Masterplan continues ====\n');
